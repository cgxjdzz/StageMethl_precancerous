...
pd$label=mapvalues(pd$label, c("Solid Tissue Normal","intestinal metaplasia biopsy from gastric antrum" ,"Primary Tumor"),c("Normal",'Precancer',"Tumor"))
...
gastric_hyper_hypo=gastric_hyper_hypo[order(normal_v_pre_hyper[gastric_hyper_hypo,]$adj.P.Val)][c(1:20)]
#gastric_hypo_hyper=gastric_hypo_hyper[order(normal_v_pre_hypo[gastric_hypo_hyper,]$adj.P.Val)][c(1:20)]
gastric_hyper_hyper=gastric_hyper_hyper[order(normal_v_pre_hyper[gastric_hyper_hyper,]$adj.P.Val)][c(1:20)]
gastric_hypo_hypo=gastric_hypo_hypo[order(normal_v_pre_hypo[gastric_hypo_hypo,]$adj.P.Val)][c(1:20)]
gastric_hyper_back_to_normal=gastric_hyper_back_to_normal[order(normal_v_pre_hyper[gastric_hyper_back_to_normal,]$adj.P.Val)][c(1:20)]
gastric_hypo_back_to_normal=gastric_hypo_back_to_normal[order(normal_v_pre_hypo[gastric_hypo_back_to_normal,]$adj.P.Val)][c(1:20)]
gastric_hypo_stable=gastric_hypo_stable[order(normal_v_pre_hypo[gastric_hypo_stable,]$adj.P.Val)][c(1:20)]
gastric_hyper_stable=gastric_hyper_stable[order(normal_v_pre_hypo[gastric_hyper_stable,]$adj.P.Val)][c(1:20)]
identical(colnames(sum_norm),pd$name)

site1=c(rep('hyper_hyper',length(gastric_hyper_hyper)),rep('hypo_hypo',length(gastric_hypo_hypo)),rep('hypo_hyper',length(gastric_hypo_hyper)),rep('hyper_hypo',length(gastric_hyper_hypo)))
...
site2=c(rep('hyper_back_to_normal',length(gastric_hyper_back_to_normal)),rep('hypo_back_to_normal',length(gastric_hypo_back_to_normal)))
...
gastric_hyper_stable=gastric_hyper_stable[order(normal_v_pre_hyper[gastric_hyper_stable,]$adj.P.Val)]
gastric_hypo_stable=gastric_hypo_stable[order(normal_v_pre_hypo[gastric_hypo_stable,]$adj.P.Val)]

site3=c(rep('hyper_stable',length(gastric_hyper_stable)),rep('hypo_stable',length(gastric_hypo_stable)))
...
all_DMP=c(gastric_hyper_hyper,gastric_hyper_stable,gastric_hyper_back_to_normal,gastric_hyper_hypo,gastric_hypo_hypo,gastric_hypo_stable,gastric_hypo_back_to_normal,gastric_hypo_hyper)
draw_data=sum_norm[all_DMP,]
site=c(rep('hyper_hyper',length(gastric_hyper_hyper)),rep('hyper_stable',length(gastric_hyper_stable)),rep('hyper_back_to_normal',length(gastric_hyper_back_to_normal)),rep('hyper_hypo',length(gastric_hyper_hypo)),rep('hypo_hypo',length(gastric_hypo_hypo)),rep('hypo_stable',length(gastric_hypo_stable)),rep('hypo_back_to_normal',length(gastric_hypo_back_to_normal)),rep('hypo_hyper',length(gastric_hypo_hyper)))
...
pdf('0320 8site_gastric_heatmap.pdf')
p=Heatmap(draw_data,show_row_names = F,top_annotation = nana,
          col=colorRamp2(c(0, 0.5, 1), c("#89C762", "white", "#F6AE60")),
          
          name = 'gastric',show_column_names = F,cluster_columns = F,column_dend_reorder = F,
